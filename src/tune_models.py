...
from train import delta_model_data, audio_data, TRAIN_STEPS_PER_EPOCH, VALID_STEPS_PER_EPOCH
...
def tune(model_fn, project_name, feature): 
    if feature == 'audio': 
        ...
        train_data, valid_data, test_data = delta_model_data
    tuner = kt.Hyperband(model_fn, objective = 'val_accuracy', max_epochs = 50, factor = 3, directory = '/home/hy381/rds/hpc-work/model_tuning', project_name = project_name)
